...
def decode_variables(variables: dict[str, Any]) -> CamundaVariables:
    """
    Read camunda variables from a dict
    """
    preprocessed = preprocess_var_dict(variables)

    variables = Camunda7VariablesAdapter.validate_python(preprocessed)
